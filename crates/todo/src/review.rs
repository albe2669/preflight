...
use crate::entity::enums::EventActor;
use crate::entity::todo::{Entity as TodoEntity, Model as Todo};
use crate::entity::todo_day_plan::{Column as DayPlanColumn, Entity as DayPlanEntity};
use crate::entity::todo_event::{Column as EventColumn, Entity as EventEntity};
...
impl ReviewServiceImpl {
    ...
    async fn todos_by_ids(&self, ids: &[i64]) -> Result<Vec<Todo>> {
        ...
        let rows = TodoEntity::find()
            .filter(crate::entity::todo::Column::Id.is_in(ids.to_vec()))
            .all(&self.db)
            .await?;
